...
public class ViewCurrentRideResponseModel {
    ...
    public static class DataEntity {
        ...
        private DriveDetaisEntity drive_detais;
        ...
        public DriveDetaisEntity getDrive_detais() {
            return drive_detais;
        }

        public void setDrive_detais(DriveDetaisEntity drive_detais) {
            this.drive_detais = drive_detais;
        }
        ...
        public static class DriveDetaisEntity {
            /**
             * distance : null
             * time : null
             */
